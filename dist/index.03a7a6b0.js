(function(window) {
    ...
    function getQuantityValueAndUnit(ob) {
        if (typeof ob != 'undefined' && typeof ob.valueQuantity != 'undefined' && typeof ob.valueQuantity.value != 'undefined' && typeof ob.valueQuantity.unit != 'undefined') return ob.valueQuantity.value + ' ' + ob.valueQuantity.unit;
    ...
    window.drawVisualization = function(p) {
        ...
        $('#ldl').html(p.ldl);
        $('#hdl').html(p.hdl);
        $('#fhirpatientid').html(p.id);
        $('#mrn').html(p.mrn);
    };
})(window);

//# sourceMappingURL=index.03a7a6b0.js.map
